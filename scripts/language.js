...
btn.addEventListener('click', () => {
    if (language == true) {
        ...
        $('.text11').text("On November 5, 1830, Chopin left Poland forever: he left Kalisz and traveled via Wrocław to Dresden. In Vienna, he heard Rossini's cavatina sung by Konstancja and burst into tears. He went to Munich and finally went to Paris. Along the way, Chopin wrote a diary (known as the 'Stuttgart Diary'), showing his state of mind during his stay in Stuttgart, where he was overcome with despair over the fall of the November Uprising. According to tradition, it was then that the first sketches for the 'Revolutionary' Etude were created. Pieces of this period are filled with drama, which slowly begins to dominate the composer's oeuvre.");
        $('.text12').text("After leaving, Nohant did not compose any significant piece anymore, only a few miniatures. After the revolution in Paris broke out in 1848, Chopin left for England and Scotland on a journey that exhausted his strength. On November 16, 1848, his last public concert took place at the Guildhall in London. The organizer and sponsor of the stay was his student, a Scot, Jane Stirling, known as 'Chopin's widow'.");
        $('.text13').text("Chopin died in the vicinity of several people close to him around 2 a.m. on October 17, 1849 in Paris, and the doctor wrote tuberculosis as the cause on his death certificate.");
